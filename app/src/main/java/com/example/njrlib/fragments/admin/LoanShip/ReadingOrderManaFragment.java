...
import com.example.njrlib.adapters.admin.Order.ReadingOrderManaAdapter;
import com.example.njrlib.adapters.admin.Order.WaitOrderManaAdapter;
import com.example.njrlib.database.DataFireBase;
import com.example.njrlib.databinding.FragmentReadingOrderManaBinding;
...
public class ReadingOrderManaFragment extends Fragment {

    DataFireBase dataFireBase;
    DataFireBase.LoanSlipData loanSlipData;
    ArrayList<LoanSlip> list;
    ReadingOrderManaAdapter adapter;
    FragmentReadingOrderManaBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding=FragmentReadingOrderManaBinding.inflate(inflater);
    ...
    private void initUI(){
        adapter=new ReadingOrderManaAdapter(list);
